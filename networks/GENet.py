...
import sys, os
from utils.attention import CDGAttention, ACCAttention
...
class Decoder_Module(nn.Module):
    ...
    def PCM(self, cam, f):
        n, c, h, w = f.size()
        f = F.interpolate(f, (h // 4, w // 4), mode='bilinear', align_corners=True)
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes):
        ...
        # # ===============================================================
        self.hwAttention = ACCAttention(in_dim=512, mid_dim=256, out_dim=512, num_classes=num_classes,
                                        size=[473 // 4, 473 // 4])
