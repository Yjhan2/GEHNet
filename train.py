...
from dataset.datasets_LIP import LIPDataSet
...
def get_arguments():
    ...
    parser.add_argument("--dataset", type=str, default='val', choices=['train', 'val', 'trainval', 'test'],
...
def main():
    ...
    lipDataset = LIPDataSet(args.data_dir, args.dataset, crop_size=input_size, transform=transform, batch_val=True)
    ...
    # path = osp.join(args.snapshot_dir, 'LIP_epoch_149_.pth')
    #
    # # path = osp.join(args.snapshot_dir,'LIP_epoch_new18.pth')
    # # # #
    ...
    for epoch in range(args.start_epoch, args.epochs):        
        ...
        for i_iter, batch in enumerate(trainloader):
            ...
            model.is_train = True
            model.hwAttention.is_train = True

            images, labels, hgt,wgt,hwgt,_,mask = batch
